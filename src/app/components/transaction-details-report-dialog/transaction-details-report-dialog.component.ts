...
@Component({
  selector: "app-transaction-details-report-dialog",
  templateUrl: "./transaction-details-report-dialog.component.html",
  styleUrls: ["./transaction-details-report-dialog.component.scss"]
})
export class TransactionDetailsReportDialogComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<TransactionDetailsReportDialogComponent>,
    ...
    if (data.idTransaccion) {
      ...
      data["celular"] = data.celular;
      data["idTransaccionProveedor"] = data.idTransaccionProveedor;
    } else {
      data["fechaStr"] = data.fechaStr;
      data["hora"] = data.hora;
    }  
